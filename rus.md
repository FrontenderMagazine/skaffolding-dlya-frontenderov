...
Пропустить автоматический запуск установки пакетов Bower и npm после 
скаффолдинга.

* `--test-framework <framework>`

По-умолчанию установлен `mocha`. Может быть использован любой другой 
фреймворк для запуска тестов, вроде Jasmine.
...
[пост в блоге у Артёма Сапегина][sapegin-grunt], 
...
зрения фронт-энд разработчика за счет плоского дерева зависимостей и 
удобное API, которое может быть использовано для реализации более 
